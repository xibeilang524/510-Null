...
**	函数返回值定义
*********************************************************************************************************/
#define S10_SUCCESS_SETTING				0
#define S10_SYSTEMNOTSUPPORT			1
#define S10_COMNOTOPEN					5
#define S10_COMISUSING					6
#define S10_COMOPENERROR				7
#define S10_OPENDRIVEFAILED				2
#define S10_OPERATIONMODENOTSUPPORT		3
#define S10_ROLENOTSUPPORT				8
#define S10_ENDFAILED					10
#define S10_RECEIVETIMEOUT				11
#define S10_RECEIVEEXCEPTION			12
#define S10_ERROR_SETTING				13
#define S10_FAILURE_SETTING				14
#define S10_UNKNOWN_SETTING				15
#define S10_PARAMINVALID				17
#define S10_SETINQUIRECONFFAILED		18
#define S10_DISC_LINK_LOSS				19
#define S10_DISC_NO_SLC					20
#define S10_DISC_TIMEOUT				21
#define S10_DISC_ERROR					22
#define S10_BUFFERTOOSMALL				23
#define S10_SETTOATMODEFAILED			24
#define S10_COMPARAMERROR				25
#define S10_MODEERROR					26
#define S10_SENDDATAERROR				27

//操作模式
enum S10_OperationMode		
{
	S10_ATCommandMode,			//AT命令模式
	S10_CommunicationMode		//通信模式
};
...
**							MODEERROR				模式错误（不处于AT模式）
*********************************************************************************************************/
BlueToothS10_API int S10_SetDeviceName(char buf[],int bufLength);
