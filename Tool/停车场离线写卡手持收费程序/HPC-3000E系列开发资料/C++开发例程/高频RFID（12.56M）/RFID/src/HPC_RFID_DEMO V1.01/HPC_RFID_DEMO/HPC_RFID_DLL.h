...
#ifdef HPC_RFID_DLL_EXPORTS
#define HPC_RFID_DLL_API __declspec(dllexport)
#else
#define HPC_RFID_DLL_API __declspec(dllimport)
#endif
...
#define RFID_STATUS_CHECK_ERROR		0x02		// 自动检测错误
