    ...
    public class UnitWork : IUnitWork
    {
        ...
        public CommandResult Commit()
        {
            try
            {
                ...
                return new CommandResult(Ralid.Park.BusinessModel.Enum.ResultCode.Successful,
                    Ralid.Park.BusinessModel.Enum.ResultCode.Successful.ToString());

            }
            catch (Exception ex)
            {
                Ralid.GeneralLibrary.ExceptionHandling.ExceptionPolicy.HandleException(ex, "UnitWork.Commit()");
                return new CommandResult(Ralid.Park.BusinessModel.Enum.ResultCode.Fail , ex.Message);
            }
        }
    }
}
