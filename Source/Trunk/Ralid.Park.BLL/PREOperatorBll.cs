...
namespace Ralid.Park.BLL
{
    public class PREOperatorBll
    {
        ...
        public PREOperatorBll(string repoUri)
        {
            provider = ProviderFactory.Create<IPREOperatorProvider>(repoUri);
        }
        #endregion

        #region 私有变量
        private IPREOperatorProvider provider;
        #endregion
        ...
        /// <returns></returns>
        public QueryResult<PREOperatorInfo> GetByID(string optID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public QueryResultList<PREOperatorInfo> GetAllOperators()
        {
        ...
        /// 根据查询条件获取操作员
        /// </summary>
        public QueryResultList<PREOperatorInfo> GetOperators(OperatorSearchCondition search)
        {
