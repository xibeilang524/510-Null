...
namespace Ralid.Park.BusinessModel.Model
{
    ...
    [Serializable()]
    [DataContract]
    public class PREOperatorInfo
    {
        private static Ralid.GeneralLibrary.SoftDog.DSEncrypt DES = new GeneralLibrary.SoftDog.DSEncrypt();
        private static PREOperatorInfo currentOperator;
        /// <summary>
        /// 获取或设置当前的操作员
        /// </summary>
        public static PREOperatorInfo CurrentOperator
        {
        ...
        /// </summary>
        [DataMember]
        public PRERoleInfo Role { get; set; }
        /// <summary>
        /// 操作员编号
        /// </summary>
        [DataMember]
