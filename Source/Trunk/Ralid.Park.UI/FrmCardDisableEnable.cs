        ...
        private void CardReadHandler(object sender, CardReadEventArgs e)
        {
            Action action = delegate()
            {
                ...
                else
                {
                    ...
                    if (DisableEnableCard != null)
                    {
                        CardDateResolver.Instance.SetCardInfoFromData(DisableEnableCard, e[GlobalVariables.ParkingSection], true);
                    }
                    else
                    {
                        DisableEnableCard = CardDateResolver.Instance.GetCardInfoFromData(e.CardID, e[GlobalVariables.ParkingSection]);
                    }
