...
namespace Ralid.Park.BusinessModel.Model
{
    ...
    public class DatetimeInterval
    {
        ...
        public override string ToString()
        {
            ...
            {
                return string.Format("{0}{1}", span.Minutes, Resouce.Resource1.Minute);
            }
            else
            {
                return string.Format("{0}{1}{2}{3}", span.Days * 24 + span.Hours, Resouce.Resource1.Hour, span.Minutes, Resouce.Resource1.Minute);
            }
        }
