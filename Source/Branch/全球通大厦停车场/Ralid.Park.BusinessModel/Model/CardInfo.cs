...
namespace Ralid.Park.BusinessModel.Model
{
    ...
    public class CardInfo
    {
        ...
        /// <summary>
        /// 获取或设置最近一次更新限时停车时长的时间
        /// </summary>
        [DataMember]
        public DateTime? LimitationTimestamp { get; set; }
        /// <summary>
        /// 获取或设置卡片描述
        /// </summary>
        [DataMember]
        ...
        /// 获取或设置卡片是否计算夜间停车时长
        /// </summary>
        public bool EnableLimitation
        {
            get { return (Options & CardOptions.EnableLimitation) == CardOptions.EnableLimitation; }
            set
            {
                Options |= CardOptions.EnableLimitation;
                if (!value) Options -= CardOptions.EnableLimitation;
            }
        }
        #endregion
