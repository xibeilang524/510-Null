...
namespace Ralid.Park.UI
{
    public partial class FrmSystemOption : Form
    {
        ...
        {
            this.comVideoType.Items.Add("A");
            this.comVideoType.Items.Add("B");
            ...
            //限时停车
            if (us.LimitationTimezone != null)
            {
                this.dtLimitationBegin.Value = new DateTime(2010, 1, 1, us.LimitationTimezone.Beginning.Hour, us.LimitationTimezone.Beginning.Minute, 0);
                this.dtLimitationEnd.Value = new DateTime(2011, 1, 1, us.LimitationTimezone.Ending.Hour, us.LimitationTimezone.Ending.Minute, 0);
            }
            this.txtLimitationPerMonth.DecimalValue = us.LimitationPerMonth;
            this.chkDisableInHoliday.Checked = us.DisableInHoliday;
        }
        ...
        private UserSetting GetUserSettingFromInput()
        {
            ...
            //限时停车
            info.LimitationTimezone = new BusinessModel.Model.TimeZone();
            info.LimitationTimezone.Beginning = new TimeEntity(this.dtLimitationBegin.Value.Hour, this.dtLimitationBegin.Value.Minute);
            info.LimitationTimezone.Ending = new TimeEntity(this.dtLimitationEnd.Value.Hour, this.dtLimitationEnd.Value.Minute);
            info.LimitationPerMonth = this.txtLimitationPerMonth.DecimalValue;
            info.DisableInHoliday = this.chkDisableInHoliday.Checked;
            return info;
        }
        #endregion
        ...
        #region 收费标准
        private void InitTariffGridRow(DataGridViewRow row, CarType carType, TariffSetting ts)
        {
