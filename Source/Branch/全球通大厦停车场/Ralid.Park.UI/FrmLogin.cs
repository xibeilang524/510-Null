...
namespace Ralid.Park.UI
{
    public partial class FrmLogin : Form
    {
        ...
        private bool UpGradeDataBase()
        {
            ...
            {
                return DatabaseUpgrader.ExeSQLFile(AppSettings.CurrentSetting.ParkConnect, path);
            }
            return false;
        }
        ...
        private void Login_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(AppSettings.CurrentSetting.ParkConnect))
            {
                try
                {
                    sb = new SqlConnectionStringBuilder(AppSettings.CurrentSetting.ParkConnect);
