    ...
    public partial class FrmCardRelease : Form
    {
        ...
        private void CardReadOffLineHandler(CardReadEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ReleasingCard = CardDateResolver.Instance.GetCardInfoFromData(e.CardID, e.ParkingDate);
                }
                else
                {
                    CardDateResolver.Instance.SetCardInfoFromData(ReleasingCard, e.ParkingDate, true);
                }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (ReleasingCard != null)
            {
                if (CheckInput())
                {
                    ...
                    CommandResult result = bll.CardRelease(ReleasingCard, txtRecieveMoney.DecimalValue, comPaymentMode.SelectedPaymentMode, txtMemo.Text.Trim(), !AppSettings.CurrentSetting.EnableWriteCard);
