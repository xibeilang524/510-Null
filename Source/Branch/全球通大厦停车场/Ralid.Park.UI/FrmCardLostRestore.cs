    ...
    public partial class FrmCardLostRestore :Form 
    {
        ...
        private void CardReadHandler(object sender, CardReadEventArgs e)
        {
            Action action = delegate()
            {
                ...
                else
                {
                    ...
                    if (LossRestoreCard != null)
                    {
                        CardDateResolver.Instance.SetCardInfoFromData(LossRestoreCard, e.ParkingDate, true);
                    }
                    else
                    {
                        LossRestoreCard = CardDateResolver.Instance.GetCardInfoFromData(e.CardID, e.ParkingDate);
                    }
                    this.ucCardInfo.Card = LossRestoreCard;
                    readCard = true;
                }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    result = bll.CardLoss(LossRestoreCard, this.txtMemo.Text, txtCardCost.DecimalValue, comPaymentMode.SelectedPaymentMode, !AppSettings.CurrentSetting.EnableWriteCard);
                }
            }
